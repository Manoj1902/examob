            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between w-full">
                    ...
                    <div className={styles.textContainer}>
                        ...
                        <p>As a distributor, we offer a wide range of laptop batteries for various brands and models, ensuring that you can find the right battery for your specific needs. Our batteries are competitively priced, and we strive to provide the best value to our customers.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div className={styles.textContainerLinks}>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">
                        © 2024&nbsp;
                        <a href="https://examob.com/" className="hover:underline font-bold">
                            Examob
                        </a>
                        . All Rights Reserved.
                    </span>
